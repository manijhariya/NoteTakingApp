...
class SignUpAPITest(APITestCase):
    ...
    def test_user_singup_all_field_required(self):
        ...
        response = self.client.post(self.url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, msg="Field is required failed")
    ...
    def test_user_singup_pass_not_match(self):
        ...
        response = self.client.post(self.url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, msg="Password1 and Password2 do not match.")
    ...
    def test_user_singup_invalid_email(self):
        ...
        response = self.client.post(self.url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, msg="Invalid Email Failed")
    ...
    def test_user_singup_duplicate_username(self):
        ...
        response = self.client.post(self.url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, msg="Duplicate username Failed.")
    ...
    def test_user_singup_duplicate_email(self):
        ...
        response = self.client.post(self.url, data)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, msg="Duplicate email Failed.")
